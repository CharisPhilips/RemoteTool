...
//    private final ResourceBundle settings;
    ...
    protected AboutDialog(Frame owner, URL sidebarImageUrl, URL brandingImageUrl) {
        super(owner, true);
...
//        		);
        ...
        websiteButton.addActionListener(e -> AppUtils.browse("https://openindex.de/"));

        // github button
        JButton githubButton = new JButton();
        githubButton.setText("Source code");
        githubButton.addActionListener(e -> AppUtils.browse("https://github.com/OpenIndex/RemoteSupportTool"));
    ...
    private String replaceVariables(String text) {
        ...
        replacements.setProperty("app.title", "Staff Support Tool");
        replacements.setProperty("app.version", Constants.version);
        replacements.setProperty("openjdk.name", StringUtils.defaultIfBlank(SystemUtils.JAVA_RUNTIME_NAME, SystemUtils.JAVA_VM_NAME));
        replacements.setProperty("openjdk.version", StringUtils.defaultIfBlank(SystemUtils.JAVA_RUNTIME_VERSION, SystemUtils.JAVA_VERSION));
