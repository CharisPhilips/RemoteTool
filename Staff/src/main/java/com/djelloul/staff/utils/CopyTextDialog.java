 ...
 */
package com.djelloul.staff.utils;
...
import com.djelloul.staff.StaffApplication;
import com.djelloul.staff.StaffFrame;
...
public abstract class CopyTextDialog extends JDialog {
    ...
    public void createAndShow() {
        setTitle("Paste on the remote machine");
        ...
        submitButton.setText("Copy text");
        ...
        // update form
        textField.setText("Enter the text you like to copy into the clipboard of the remote machine.");
