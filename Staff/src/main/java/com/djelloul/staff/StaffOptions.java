...
/**
 * Options of the staff application.
 *
 * @author Djelloul
 */
...
public class StaffOptions extends AbstractOptions {
    ...
    public Boolean getSsh() {
        Boolean defaultValue = Constants.default_ssh;
    ...
    public String getSshKey() {
        ...
        return StringUtils.defaultIfBlank(getProperty("sshKey"), StringUtils.defaultIfBlank(defaultValue, AppUtils.getDefaultSshKey()));
    }
    ...
    public Integer getSshPort() {
        Integer defaultValue;
        try {
            defaultValue = Constants.default_sshPort;
        } catch (NumberFormatException ex) {
            defaultValue = 22;
        }
    ...
    public Boolean getSshKeyAuth() {
        Boolean defaultValue = Constants.default_sshKeyAuth;
    ...
    public Integer getSshRemotePort() {
        Integer defaultValue;
        try {
            defaultValue = Constants.default_sshRemotePort;
        } catch (NumberFormatException ex) {
            defaultValue = 55555;
        }
    ...
    public String getSshUser() {
        String defaultValue = ""; //StringUtils.trimToEmpty(settings.getString("default.sshUser"))
